    ...
    <form id="form1" runat="server">
        <div class="container">
           ...
           <h2>File List Available </h2>
            ...
            <asp:GridView ID="GridView1" UseAccessibleHeader="true" CssClass="table table-hover table-striped" runat="server" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="Id" DataSourceID="SqlDataSource1">
                <Columns>
...
WHERE        (Users.active = 'true')"></asp:SqlDataSource>
